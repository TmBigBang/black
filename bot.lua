...
*راهنمای ربات*
        ...
        tdcli.sendText(chat_id, msg.id_, 0, 1, nil, '<b>Lock:[strict.spam.links.webpage.tag.hashtag.fwd.bots.edit.markdown.mention.pin.inline.farsi.english.tgservice.flood]
🔒قفل های اصلی:‌
